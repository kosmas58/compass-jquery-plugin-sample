...
ActionView::Helpers::AssetTagHelper.register_stylesheet_expansion :mobile_960 => ['compiled/jquery/mobile/grid960.css']
ActionView::Helpers::AssetTagHelper.register_stylesheet_expansion :mobile_960_fluid => ['compiled/jquery/mobile/grid960.fluid.css']
