class Jqtouch::JonathanStark::KiloOfflineController < ApplicationController
  layout 'jqt_offline'
  ...
  def manifest
    manifest =  "CACHE MANIFEST\n\n" +
                "images/demo/jqtouch/jonathan_stark/kilo_icon.png\n" +
                "images/demo/jqtouch/jonathan_stark/kilo_startup.png\n" +
