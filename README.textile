...
It this prelease you have to create gem from source.
...
You don't need to run the compass -f jquery commands, because that has been already done for the example.
