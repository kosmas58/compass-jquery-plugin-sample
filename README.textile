h1. compass-jquery-plugin-sample application

Get it from <b>"here":http://github.com/kosmas58/compass-jquery-plugin-sample</b>.

h2. Description

A Sass-based Meta-Framework for Compass that allows you to mix and match any of the following:

* jRails with jQuery 1.3.2 and jQuery.UI 1.7.2 or jQuery 1.4.2 and jQuery 1.8 including themes
* dynatree V0.5.2
* jqGrid V3.6.4
* jQTouch V1.0b2
