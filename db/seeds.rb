...
Bird.create!(:name => "Short-toed Jstree.Creeper", :scientific_name => "Certhia brachydactyla")
Bird.create!(:name => "Wood Lark", :scientific_name => "Lullula arborea")
Bird.create!(:name => "Jstree.Pipit", :scientific_name => "Anthus trivialis")
...
Bird.create!(:name => "Eurasian Jstree.Sparrow", :scientific_name => "Passer montanus")
...
Bird.create!(:name => "Eurasian Jstree.reeper", :scientific_name => "Certhia familiaris")
...
Bird.create!(:name => "Olive-Jstree.Warbler", :scientific_name => "Hippolais olivetorum")
...
#Jstree.
Jstree.create(:parent_id => 0, :position => 2, :left => 1,  :right => 20, :level => 0, :title => 'ROOT')
Jstree.create(:parent_id => 1, :position => 0, :left => 2,  :right => 17, :level => 1, :title => 'C:',         :ntype => 'drive')
Jstree.create(:parent_id => 2, :position => 0, :left => 3,  :right => 12, :level => 2, :title => '_demo:',     :ntype => 'folder')
Jstree.create(:parent_id => 3, :position => 0, :left => 4,  :right => 5,  :level => 3, :title => 'index.html', :ntype => 'default')
Jstree.create(:parent_id => 2, :position => 1, :left => 13, :right => 16, :level => 2, :title => '_docs',      :ntype => 'folder')
Jstree.create(:parent_id => 1, :position => 1, :left => 18, :right => 19, :level => 1, :title => 'zmei.html',  :ntype => 'drive')
Jstree.create(:parent_id => 5, :position => 0, :left => 14, :right => 15, :level => 3, :title => 'New node',   :ntype => 'default')
Jstree.create(:parent_id => 3, :position => 1, :left => 6,  :right => 9,  :level => 3, :title => 'New node',   :ntype => 'folder')
Jstree.create(:parent_id => 3, :position => 2, :left => 10, :right => 11, :level => 3, :title => 'New node',   :ntype => 'default')
Jstree.create(:parent_id => 9, :position => 0, :left => 7,  :right => 8,  :level => 4, :title => 'New node',   :ntype => 'default')
