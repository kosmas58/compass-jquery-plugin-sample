...
parent_id = node_1
node_2 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 0, :title => 'txt.ui.name', :type => 'accordion', :icon => '/images/jstree/jquery-ui.png')
parent_id = node_2
node_3 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 0, :title => 'txt.ui.interactions.default', :type => 'folder', :icon => '/images/jstree/jquery-ui.png')
parent_id = node_3
node_4 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 0, :title => 'txt.ui.interactions.draggable.default', :type => 'folder', :icon => '/images/jstree/jquery-ui.png')
parent_id = node_4
...
parent_id = node_3
node_16 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 1, :title => 'txt.ui.interactions.droppable.default', :type => 'folder', :icon => '/images/jstree/jquery-ui.png')
parent_id = node_16
...
parent_id = node_3
node_24 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 2, :title => 'txt.ui.interactions.resizable.default', :type => 'folder', :icon => '/images/jstree/jquery-ui.png')
parent_id = node_24
...
parent_id = node_3
node_36 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 3, :title => 'txt.ui.interactions.selectable.default', :type => 'folder', :icon => '/images/jstree/jquery-ui.png')
parent_id = node_36
...
parent_id = node_3
node_40 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 4, :title => 'txt.ui.interactions.sortable.default', :type => 'folder', :icon => '/images/jstree/jquery-ui.png')
parent_id = node_40
...
parent_id = node_3
parent_id = node_2
node_50 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 1, :title => 'txt.ui.widgets.default', :type => 'folder', :icon => '/images/jstree/jquery-ui.png')
parent_id = node_50
node_51 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 0, :title => 'txt.ui.widgets.accordion.default', :type => 'folder', :icon => '/images/jstree/jquery-ui.png')
parent_id = node_51
...
parent_id = node_50
node_60 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 1, :title => 'txt.ui.widgets.autocomplete.default', :type => 'folder', :icon => '/images/jstree/jquery-ui.png')
parent_id = node_60
...
parent_id = node_50
node_73 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 2, :title => 'txt.ui.widgets.button.default', :type => 'folder', :icon => '/images/jstree/jquery-ui.png')
parent_id = node_73
...
parent_id = node_50
node_80 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 3, :title => 'txt.ui.widgets.datepicker.default', :type => 'folder', :icon => '/images/jstree/jquery-ui.png')
parent_id = node_80
...
parent_id = node_50
node_95 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 4, :title => 'txt.ui.widgets.dialog.default', :type => 'folder', :icon => '/images/jstree/jquery-ui.png')
parent_id = node_95
...
parent_id = node_50
node_102 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 5, :title => 'txt.ui.widgets.progressbar.default', :type => 'folder', :icon => '/images/jstree/jquery-ui.png')
parent_id = node_102
...
parent_id = node_50
node_106 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 6, :title => 'txt.ui.widgets.slider.default', :type => 'folder', :icon => '/images/jstree/jquery-ui.png')
parent_id = node_106
...
parent_id = node_50
node_119 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 7, :title => 'txt.ui.widgets.tabs.default', :type => 'folder', :icon => '/images/jstree/jquery-ui.png')
parent_id = node_119
...
parent_id = node_50
parent_id = node_2
node_128 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 2, :title => 'txt.ui.effects.default', :type => 'folder', :icon => '/images/jstree/jquery-ui.png')
parent_id = node_128
...
node_137 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 8, :title => 'txt.ui.effects.effect.default', :type => 'folder', :icon => '/images/jstree/jquery-ui.png')
parent_id = node_137
...
parent_id = node_128
parent_id = node_2
node_140 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 3, :title => 'txt.ui.utilities.default', :type => 'folder', :icon => '/images/jstree/jquery-ui.png')
parent_id = node_140
node_141 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 0, :title => 'txt.ui.utilities.position.default', :type => 'folder', :icon => '/images/jstree/jquery-ui.png')
parent_id = node_141
...
parent_id = node_2
parent_id = node_1
node_144 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 1, :title => 'txt.plugins.name', :type => 'accordion', :icon => '/images/jstree/plugin.png')
parent_id = node_144
node_145 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 0, :title => 'txt.jst.name', :type => 'folder', :icon => '/images/jstree/tree.png')
parent_id = node_145
...
node_147 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 1, :title => 'txt.jst.plugins', :type => 'folder', :icon => '/images/jstree/tree.png')
parent_id = node_147
...
parent_id = node_145
parent_id = node_144
node_167 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 1, :title => 'txt.dt.name', :type => 'folder', :icon => '/images/jstree/tree.png')
parent_id = node_167
...
node_173 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 5, :title => 'txt.dt.theming.name', :type => 'folder', :icon => '/images/jstree/tree.png')
parent_id = node_173
...
parent_id = node_144
node_190 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 2, :title => 'txt.ribbon.name', :type => 'folder', :icon => '/images/jstree/ribbon.png')
parent_id = node_190
...
parent_id = node_144
node_194 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 3, :title => 'txt.jqgrid.name', :type => 'folder', :icon => '/images/jstree/working.png')
parent_id = node_194
node_195 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 0, :title => 'txt.jqgrid.demo.gridify', :type => 'folder', :icon => '/images/jstree/working.png')
parent_id = node_195
node_196 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 0, :title => 'txt.jqgrid.simple.name', :type => 'folder', :icon => '/images/jstree/working.png')
parent_id = node_196
...
parent_id = node_195
node_202 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 1, :title => 'txt.jqgrid.manipulation.name', :type => 'folder', :icon => '/images/jstree/grid.png')
parent_id = node_202
...
parent_id = node_195
node_207 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 2, :title => 'txt.jqgrid.subgrids.name', :type => 'folder', :icon => '/images/jstree/grid.png')
parent_id = node_207
...
parent_id = node_194
node_212 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 1, :title => 'txt.jqgrid.demo.default', :type => 'folder', :icon => '/images/jstree/working.png')
parent_id = node_212
node_213 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 0, :title => 'txt.jqgrid.demo.20loading', :type => 'folder', :icon => '/images/jstree/grid.png')
parent_id = node_213
...
parent_id = node_212
node_218 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 1, :title => 'txt.jqgrid.demo.20manipulating', :type => 'folder', :icon => '/images/jstree/working.png')
parent_id = node_218
...
parent_id = node_212
node_222 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 2, :title => 'txt.jqgrid.demo.20advanced', :type => 'folder', :icon => '/images/jstree/working.png')
parent_id = node_222
...
parent_id = node_212
node_229 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 3, :title => 'txt.jqgrid.demo.30v', :type => 'folder', :icon => '/images/jstree/grid.png')
parent_id = node_229
...
parent_id = node_212
node_235 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 4, :title => 'txt.jqgrid.demo.30row', :type => 'folder', :icon => '/images/jstree/working.png')
parent_id = node_235
...
parent_id = node_212
node_241 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 5, :title => 'txt.jqgrid.demo.30mapping', :type => 'folder', :icon => '/images/jstree/working.png')
parent_id = node_241
...
parent_id = node_212
node_245 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 6, :title => 'txt.jqgrid.demo.30integrations', :type => 'folder', :icon => '/images/jstree/grid.png')
parent_id = node_245
...
parent_id = node_212
node_247 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 7, :title => 'txt.jqgrid.demo.30live', :type => 'folder', :icon => '/images/jstree/grid.png')
parent_id = node_247
...
parent_id = node_212
node_253 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 8, :title => 'txt.jqgrid.demo.31v', :type => 'folder', :icon => '/images/jstree/working.png')
parent_id = node_253
...
parent_id = node_212
node_259 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 9, :title => 'txt.jqgrid.demo.32v', :type => 'folder', :icon => '/images/jstree/working.png')
parent_id = node_259
...
parent_id = node_212
node_267 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 10, :title => 'txt.jqgrid.demo.33v', :type => 'folder', :icon => '/images/jstree/working.png')
parent_id = node_267
...
parent_id = node_212
node_277 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 11, :title => 'txt.jqgrid.demo.34v', :type => 'folder', :icon => '/images/jstree/working.png')
parent_id = node_277
...
parent_id = node_212
node_284 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 12, :title => 'txt.jqgrid.demo.35v', :type => 'folder', :icon => '/images/jstree/working.png')
parent_id = node_284
...
parent_id = node_212
node_294 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 13, :title => 'txt.jqgrid.demo.36v', :type => 'folder', :icon => '/images/jstree/working.png')
parent_id = node_294
...
parent_id = node_212
node_306 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 14, :title => 'txt.jqgrid.demo.37v', :type => 'folder', :icon => '/images/jstree/working.png')
parent_id = node_306
...
parent_id = node_212
node_314 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 15, :title => 'txt.jqgrid.demo.38v', :type => 'folder', :icon => '/images/jstree/working.png')
parent_id = node_314
...
parent_id = node_212
parent_id = node_194
node_326 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 2, :title => 'txt.jqgrid.demo.2dc', :type => 'folder', :icon => '/images/jstree/grid.png')
parent_id = node_326
node_327 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 0, :title => 'txt.jqgrid.subgrids.name', :type => 'folder', :icon => '/images/jstree/grid.png')
parent_id = node_327
node_328 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 0, :title => 'txt.jqgrid.subgrids.default', :type => 'default', :icon => '/images/jstree/grid.png', :url => '/jqgrid/users?example=10')
node_329 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 1, :title => 'txt.jqgrid.subgrids.crud', :type => 'default', :icon => '/images/jstree/grid.png', :url => '/jqgrid/users?example=11')
node_330 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 2, :title => 'txt.jqgrid.subgrids.selection', :type => 'default', :icon => '/images/jstree/grid.png', :url => '/jqgrid/users?example=12')
parent_id = node_326
parent_id = node_194
node_331 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 3, :title => 'txt.jqgrid.secret', :type => 'default', :icon => '/images/jstree/grid.png', :url => '/jqgrid/widgets')
parent_id = node_144
node_332 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 4, :title => 'txt.jqical.name', :type => 'folder', :icon => '/images/jstree/working.png')
parent_id = node_332
node_333 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 0, :title => 'txt.jqical.anytime.name', :type => 'folder', :icon => '/images/jstree/alarmclock.png')
parent_id = node_333
node_334 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 0, :title => 'txt.jqical.anytime.default', :type => 'default', :icon => '/images/jstree/alarmclock.png', :url => '/jqical/anytime/default')
node_335 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 1, :title => 'txt.jqical.anytime.inline', :type => 'default', :icon => '/images/jstree/alarmclock.png', :url => '/jqical/anytime/inline')
node_336 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 2, :title => 'txt.jqical.anytime.separate', :type => 'default', :icon => '/images/jstree/alarmclock.png', :url => '/jqical/anytime/separate')
node_337 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 3, :title => 'txt.jqical.anytime.css', :type => 'default', :icon => '/images/jstree/alarmclock.png', :url => '/jqical/anytime/css')
node_338 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 4, :title => 'txt.jqical.anytime.ajax', :type => 'default', :icon => '/images/jstree/alarmclock.png', :url => '/jqical/anytime/ajax')
node_339 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 5, :title => 'txt.jqical.anytime.convert', :type => 'default', :icon => '/images/jstree/alarmclock.png', :url => '/jqical/anytime/convert')
node_340 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 6, :title => 'txt.jqical.anytime.extend', :type => 'default', :icon => '/images/jstree/alarmclock.png', :url => '/jqical/anytime/extend')
parent_id = node_332
node_341 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 1, :title => 'txt.jqical.calendar.listing', :type => 'default', :icon => '/images/jstree/calendar.png', :url => '/jqical/calendars')
parent_id = node_144
parent_id = node_1
node_342 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 2, :title => 'txt.mobiles.name', :type => 'accordion', :icon => '/images/jstree/iphone.png')
parent_id = node_342
node_343 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 0, :title => 'txt.jqm.name', :type => 'default', :icon => '/images/jstree/working.png', :url => 'http://jquerymobile.com/')
node_344 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 1, :title => 'txt.jqt.name', :type => 'folder', :icon => '/images/jstree/iphone.png')
parent_id = node_344
node_345 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 0, :title => 'txt.jqt.demo', :type => 'default', :icon => '/images/jstree/working.png', :url => '/iphone/main')
node_346 = NavigationTree.create_node(:id => parent_id, :seed => true, :position => 1, :title => 'txt.jqt.beta', :type => 'default', :icon => '/images/jstree/iphone.png', :url => '/iphone/original')
parent_id = node_342
parent_id = node_1
